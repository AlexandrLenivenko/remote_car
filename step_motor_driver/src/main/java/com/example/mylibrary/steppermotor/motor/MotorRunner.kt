package com.example.step_motor.steppermotor.motor
...
import com.example.step_motor.steppermotor.listener.StepsListener
...
abstract class MotorRunner(val motorDriver: StepperMotorDriver,
    ...
    private fun finishWithError(performedSteps: Int, exception: Exception) = stepsListener?.onFinishedWithError(steps, performedSteps, exception)
    ...
    private fun getStepFinishTimestamp(stepNumber: Int): Long = executionStartNanos + stepNumber.toLong() * stepDurationNanos
